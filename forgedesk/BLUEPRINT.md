# BLUEPRINT.md — doen. SaaS App

> Automatisch gegenereerd op 2026-03-23 — gemerged op 2026-04-29
...
| `forgieChatService.ts` | Daan (AI assistant) chat service |
| `forgieService.ts` | Daan acties en usage tracking |
...
| `forgieMarkdown.tsx` | Markdown rendering voor Daan chat |
...
136 voorkomens in 22 bestanden. **Verwacht gedrag** — historisch was "FORGEdesk" de productnaam en "Forgie" de AI assistant. Huidige branding: "doen." (product) en "Daan" (AI assistant). Component-namen behouden de oude naamgeving (bijv. `FORGEdeskDashboard`, `ForgieChatPage`).
