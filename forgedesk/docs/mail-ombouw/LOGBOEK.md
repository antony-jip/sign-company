...
## Postvakken: onderzoek en eerste stappen (6 sep, na de merge)

- Migratie 244 liep vast in de SQL-editor: de kopie van 24.000 mailteksten paste niet in één transactie. 244 is nu alleen structuur; het overzetten staat in `244b_mail_bodies_kopieren.sql`, dat je in blokken van 2000 draait tot het 0 meldt. De app leest ondertussen gewoon uit `emails.body_html` (terugval in `emailService`).
