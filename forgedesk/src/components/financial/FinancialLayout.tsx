  ...
  const statCards = [
    {
      ...
      icon: TrendingUp,
      color: 'text-[var(--color-sage-text)]',
    ...
    },
    {
      ...
      icon: TrendingDown,
      color: 'text-[var(--color-coral-text)]',
    ...
    },
    {
      ...
      icon: Euro,
      color: winst >= 0 ? 'text-[var(--color-sage-text)]' : 'text-[var(--color-coral-text)]',
      bg: winst >= 0 ? 'bg-[var(--color-sage)]' : 'bg-[var(--color-coral)]',
    },
    {
