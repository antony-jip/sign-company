      ...
      <div className="border border-[hsl(35,15%,87%)] bg-[#FFFFFE] shadow-[0_1px_3px_rgba(130,100,60,0.04)] rounded-[10px] overflow-hidden transition-shadow duration-300 hover:shadow-[0_2px_8px_rgba(130,100,60,0.08)]">
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <div className="h-2 w-2 rounded-full bg-[#7EB5A6] shadow-[0_0_6px_rgba(126,181,166,0.4)] animate-pulse" />
          </div>
        ...
        {!isCollapsed && klant && (
          <div className="px-3 py-2 border-t border-[hsl(35,15%,90%)]">
            <div className="flex items-center gap-2.5 bg-[hsl(35,15%,97%)] rounded-lg px-3 py-2">
              <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[#8BAFD4] to-[#6B8FB4] flex items-center justify-center flex-shrink-0 shadow-sm">
      ...
      >
        ...
        {klant && (
          <div className="px-3 py-2.5 border-b border-[hsl(35,15%,90%)] flex-shrink-0">
            <div className="flex items-center gap-2.5 bg-[hsl(35,15%,97%)] rounded-lg px-3 py-2">
              <div className="h-9 w-9 rounded-full bg-gradient-to-br from-[#8BAFD4] to-[#6B8FB4] flex items-center justify-center flex-shrink-0 shadow-sm">
