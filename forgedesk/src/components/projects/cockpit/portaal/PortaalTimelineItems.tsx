  ...
  return (
    <div className="flex justify-end">
      <div className="max-w-[80%] flex flex-col items-end">
        <div className="bg-background border border-mod-email-border rounded-2xl rounded-br-md overflow-hidden shadow-sm w-full">
...
export function FactuurCard({ item }: { item: PortaalItem }) {
  ...
  return (
    <div className="flex justify-end">
      <div className="max-w-[80%] flex flex-col items-end">
        <div className="bg-background border border-mod-werkbonnen-border rounded-2xl rounded-br-md overflow-hidden shadow-sm w-full">
...
export function TekeningCard({ item }: { item: PortaalItem }) {
  ...
  return (
    <div className="flex justify-end">
      <div className="max-w-[80%] flex flex-col items-end">
        <div className="bg-background border border-mod-klanten-border rounded-2xl rounded-br-md overflow-hidden shadow-sm w-full">
