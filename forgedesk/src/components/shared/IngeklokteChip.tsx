...
export function IngeklokteChip() {
  ...
  return (
    <button
      ...
      className="hidden md:inline-flex items-center gap-1.5 h-[30px] pl-2 pr-2.5 rounded-lg border border-[rgba(210, 70, 32,0.35)] bg-[hsl(var(--status-flame-bg))] text-[12px] font-medium text-[#C03A18] transition-colors hover:border-flame"
    >
      {vergeten ? (
