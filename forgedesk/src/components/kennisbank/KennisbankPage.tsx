...
const ARTICLES: KbArticle[] = [
  ...
  },
  {
    ...
    iconColor: '#2D6B48',
    titel: 'Cockpit',
    subtitel: 'Wat er in het bedrijf gebeurt, op één scherm — alleen voor beheerders',
    inhoud: [
      'De cockpit laat zien wat **aandacht verdient** (offertes die wachten, facturen die vervallen, werkbonnen klaar om te factureren, portaal-reacties, projecten zonder planning), je **cijfers** per periode (pijplijn, gefactureerd, ontvangen, openstaand naar ouderdom, inkoop, marge, conversie), wie er **nu** is ingeklokt en wat er live gebeurt.',
      'Alle bedragen zijn ex btw en komen uit één serverberekening, zodat elk getal overal hetzelfde betekent.',
      'Grootboekrekeningen en BTW-codes configureer je in Instellingen > Boekhouding.',
    ],
    link: '/cockpit',
  },
  {
