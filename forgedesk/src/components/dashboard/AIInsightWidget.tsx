  ...
  const insights = useMemo(() => {
    ...
    if (expiringOffertes.length > 0) {
      items.push({
        ...
        icon: AlertTriangle,
        iconColor: 'text-mod-taken-text',
        iconBg: 'bg-mod-taken-light',
    ...
    if (overdueTaken.length > 0) {
      items.push({
        ...
        icon: Clock,
        iconColor: 'text-mod-werkbonnen-text',
        iconBg: 'bg-mod-werkbonnen-light',
    ...
    if (completedProjects.length > 0) {
      items.push({
        ...
        icon: CheckCircle,
        iconColor: 'text-mod-facturen-text',
        iconBg: 'bg-mod-facturen-light',
        actionLabel: 'Bekijk projecten',
        href: '/projecten',
      })
    }
