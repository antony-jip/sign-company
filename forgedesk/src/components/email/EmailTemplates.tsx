  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
      ...
      <div className="space-y-3">
        <h3 className="text-xs font-bold text-text-tertiary uppercase tracking-label">
      ...
      <div className="flex flex-col">
        <h3 className="text-xs font-bold text-text-tertiary uppercase tracking-label mb-3">
          Voorbeeld
        </h3>
        {selectedTemplate ? (
