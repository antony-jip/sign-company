  ...
  useEffect(() => {
    ...
    if (exactStatus === 'connected') {
      ...
      const uitleg: Record<string, string> = {
        ...
        oauth_client: 'Exact herkent de Client ID of Client Secret niet. Haal beide opnieuw op in het Exact App Center en sla ze hier op. Let op meegekopieerde spaties.',
        oauth_grant: 'Exact accepteerde de koppelcode niet. Meestal wijkt de Redirect URI in het Exact App Center af van https://app.doen.team/api/exact-callback. Controleer die en verbind daarna opnieuw.',
        oauth_verzoek: 'Exact wees de aanvraag af omdat de app-instellingen bij Exact niet kloppen. Controleer in het Exact App Center of de app actief is en de Redirect URI ingevuld staat.',
        exact_storing: 'Exact was even niet bereikbaar. Probeer het over een paar minuten opnieuw.',
