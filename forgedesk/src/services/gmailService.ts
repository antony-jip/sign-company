...
export async function sendEmail(
  ...
  subject: string,
  body: string,
  options?: { cc?: string; html?: string; scheduledAt?: string; attachments?: Array<{ filename: string; content: string; encoding: 'base64' }>; opvolging_id?: string; metadata?: Record<string, unknown> }
