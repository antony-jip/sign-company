...
const KOLOM_HERKENNING: Record<string, string> = {
  ...
  'coc': 'kvk_nummer', 'kvk': 'kvk_nummer', 'kvk_nummer': 'kvk_nummer', 'kvk nummer': 'kvk_nummer', 'kvknummer': 'kvk_nummer',
  'debiteurennummer': 'debiteurennummer', 'debiteur': 'debiteurennummer', 'deb_nr': 'debiteurennummer', 'deb nr': 'debiteurennummer',
...
function mapKlant(row: Record<string, string>, userId: string, importBron: string) {
  ...
  return {
    ...
    debiteurennummer: getField(row, 'debiteurennummer', 'Debiteurennummer', 'deb_nr', 'deb nr', 'debiteur'),
    kvk_nummer: getField(row, 'kvk_nummer', 'KVK nummer', 'kvk nummer', 'kvk', 'KVK', 'kvknummer', 'COC', 'coc'),
