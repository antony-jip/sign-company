...
const PROMPTS: Record<string, string> = {
  ...
  'write-lead-email': 'Je schrijft een eerste, koude e-mail aan een collega-signbedrijf uit de ledenlijst van SIBON. Doel: doen. introduceren, de software die we zelf gebruiken voor offertes, projecten, werkbonnen en facturatie.\n\nBouw de mail in deze vier stappen op, in deze volgorde, als lopende alinea\'s:\n1. HET PROBLEEM — begin bij het werk zelf, niet bij software. Beschrijf een herkenbaar probleem uit ons eigen bedrijf: offertes die blijven liggen, niet weten welke klus waar staat, werkbonnen die pas achteraf terugkomen, facturen die vergeten worden. Vertel het als iets van ons, met de ondertoon dat het bij hen waarschijnlijk niet anders is.\n2. DE TUSSENSITUATIE — hoe we het daarvóór oplosten en waarom dat maar half werkte: losse Excel-lijstjes, mappen, WhatsApp, een agenda, dingen in iemands hoofd. Elk stuk werkte op zichzelf, samen gaf het geen overzicht.\n3. DE OPLOSSING — doen. Eén plek waar offerte, project, werkbon en factuur aan elkaar hangen, zodat je in één oogopslag ziet waar alles staat. Vertel wat het concreet oplost, niet wat het "biedt". Zeg expliciet dat dit geen salespitch is: je deelt iets dat bij jullie goed werkt.\n4. HET FILMPJE — verwijs naar de video in de bijlage als de makkelijkste manier om in een paar minuten te zien wat het is. Zeg dat hij in de bijlage zit (hij wordt met de hand toegevoegd), verwijs nooit naar een link, website of downloadpagina.\n\nSchrijf als ondernemer tegen ondernemer. Maximaal 180 woorden, korte alinea\'s, geen tussenkopjes en geen opsommingstekens — het moet lezen als een mail, niet als een presentatie. Geen superlatieven, geen onderwerpregel en geen ondertekening; de handtekening staat er al onder. Sluit af met een lage drempel: laat merken dat een reactie niet hoeft, geen harde call-to-action.\n\nJe weet weinig over dit bedrijf. Het probleem en de tussensituatie beschrijf je daarom altijd vanuit ons eigen bedrijf en bied je aan als herkenbaar — nooit als vaststelling over hen. Doe GEEN aannames over wat ze maken, hoe groot ze zijn, welke software ze nu gebruiken of hoe hun werk loopt. Gebruik verder uitsluitend de gegevens hieronder; ontbreekt een gegeven, laat het dan weg in plaats van het in te vullen.\n\nGegevens van de lead:\n{context}\n\nExtra aanwijzing van de gebruiker (leeg = geen):\n{text}\n\nAntwoord alleen met de e-mailtekst.',
}
