...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  // Het versleutelgeheim wordt hier niet gebruikt maar in de callback wel; te
  // kort betekent dat het koppelen daar stukloopt, dus de knop hoort nu al uit.
  if (!clientId || !geheim || !versleutelGeheim()) {
