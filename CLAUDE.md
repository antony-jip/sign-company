...
app voor interne bedrijfsvoering in de `doen/` subfolder.

> **Werk je aan de doen.-app?** Lees `doen/CLAUDE.md` — dat is de
...
├── doen/            # doen. SaaS app (Vite + React + Supabase)
...
Voor doen.-app commands: zie `doen/CLAUDE.md`.
