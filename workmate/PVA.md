# Plan van Aanpak (PVA) - Workmate CRM

## 1. Projectoverzicht

**Project:** Workmate - Business Management CRM voor Sign Company
...
|   | - Vul in: `workmate/.env` met `VITE_SUPABASE_URL` en `VITE_SUPABASE_ANON_KEY` | | |
...
Maak een bestand `workmate/.env` aan met:
...
# OpenAI (OPTIONEEL - kan ook via Instellingen > Integraties)
