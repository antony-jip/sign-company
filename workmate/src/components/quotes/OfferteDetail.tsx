      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            {statusOpen && (
              <div className="absolute top-full left-0 mt-1 z-50 bg-white dark:bg-gray-800 border border-border rounded-xl shadow-lg py-1 min-w-[160px]">
          ...
          {isEditing ? (
            ...
            <>
              ...
              <Button
                size="sm"
                variant="outline"
                onClick={() => navigate(`/offertes/${offerte.id}/pdf`)}
              >
