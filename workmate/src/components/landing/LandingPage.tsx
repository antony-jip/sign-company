      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        <div className="flex items-center justify-between h-16 sm:h-[72px]">
          <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="flex items-center gap-2.5 group">
            ...
            <span className="text-[17px] font-bold text-white tracking-tight" style={{ fontFamily: 'Manrope, sans-serif' }}>Workmate</span>
          </button>
...
const FEATURES = [
  {
    ...
    description: 'Volledig e-mailclient ingebouwd. Ontvang, beantwoord en archiveer — direct vanuit Workmate. Geen Outlook meer nodig.',
...
function TimeSavings() {
  ...
  const comparisons = [
    ...
    { task: 'E-mail beantwoorden', before: 'Alt-tab chaos', after: 'Direct in Workmate', icon: Mail },
    ...
    <footer className="bg-slate-950 border-t border-white/5 py-12 sm:py-16">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[12px] text-slate-600">© {new Date().getFullYear()} Workmate. Alle rechten voorbehouden.</p>
