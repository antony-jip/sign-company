    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <Input placeholder="Zoek op nummer, klant, project, locatie..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="pl-9" />
        </div>
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-gray-700/50">
                {gefilterd.map((lb) => {
                  ...
                  return (
                    <tr key={lb.id} className="group hover:bg-gray-50/80 dark:hover:bg-gray-700/30 transition-colors cursor-pointer" onClick={() => navigate(`/leveringsbonnen/${lb.id}`)}>
