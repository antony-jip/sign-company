...
function generateDemoProjecten(): Project[] {
  const projecten: Project[] = [
    {
      id: 'p1', klant_id: 'k1', klant_naam: 'Albert Heijn BV',
      naam: 'Gevelreclame filiaal Amstelveen', status: 'actief',
      budget: 15000, besteed: 11200, voortgang: 75,
      start_datum: '2025-09-01', eind_datum: '2026-03-15',
      created_at: '2025-09-01T00:00:00Z', updated_at: '2026-01-15T00:00:00Z',
    },
    {
      id: 'p2', klant_id: 'k2', klant_naam: 'Gemeente Amsterdam',
      naam: 'Wayfinding systeem Zuidas', status: 'actief',
      budget: 45000, besteed: 38500, voortgang: 85,
      start_datum: '2025-06-01', eind_datum: '2026-04-01',
      created_at: '2025-06-01T00:00:00Z', updated_at: '2026-02-10T00:00:00Z',
    },
    {
      id: 'p3', klant_id: 'k3', klant_naam: 'HEMA Nederland',
      naam: 'Lichtreclame 12 filialen', status: 'afgerond',
      budget: 62000, besteed: 54800, voortgang: 100,
      start_datum: '2025-03-01', eind_datum: '2025-11-30',
      created_at: '2025-03-01T00:00:00Z', updated_at: '2025-11-30T00:00:00Z',
    },
    {
      id: 'p4', klant_id: 'k4', klant_naam: 'Rijksmuseum',
      naam: 'Tentoonstellingsborden zomer', status: 'actief',
      budget: 8500, besteed: 9200, voortgang: 95,
      start_datum: '2025-11-01', eind_datum: '2026-02-28',
      created_at: '2025-11-01T00:00:00Z', updated_at: '2026-02-01T00:00:00Z',
    },
    {
      id: 'p5', klant_id: 'k5', klant_naam: 'NS Stations',
      naam: 'Perronborden vernieuwing Utrecht', status: 'actief',
      budget: 32000, besteed: 18600, voortgang: 55,
      start_datum: '2025-10-15', eind_datum: '2026-06-01',
      created_at: '2025-10-15T00:00:00Z', updated_at: '2026-01-20T00:00:00Z',
    },
    {
      id: 'p6', klant_id: 'k6', klant_naam: 'Bol.com',
      naam: 'Magazijnbebording Waalwijk', status: 'afgerond',
      budget: 21000, besteed: 19500, voortgang: 100,
      start_datum: '2025-07-01', eind_datum: '2025-10-15',
      created_at: '2025-07-01T00:00:00Z', updated_at: '2025-10-15T00:00:00Z',
    },
    {
      id: 'p7', klant_id: 'k7', klant_naam: 'Ziggo Dome',
      naam: 'LED-display entree', status: 'gepland',
      budget: 28000, besteed: 2400, voortgang: 10,
      start_datum: '2026-01-15', eind_datum: '2026-05-01',
      created_at: '2026-01-15T00:00:00Z', updated_at: '2026-02-01T00:00:00Z',
    },
    {
      id: 'p8', klant_id: 'k1', klant_naam: 'Albert Heijn BV',
      naam: 'Interne signing DC Zaandam', status: 'actief',
      budget: 18500, besteed: 16900, voortgang: 88,
