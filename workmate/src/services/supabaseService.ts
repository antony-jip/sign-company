...
8. Garantie: 2 jaar op materiaal en constructie, 1 jaar op elektronica.`,
    ...
    bestelbon_prefix: 'BB',
    bestelbon_volgnummer: 1,
    leveringsbon_prefix: 'LB',
    leveringsbon_volgnummer: 1,
    uitgave_prefix: 'UIT',
    uitgave_volgnummer: 1,
    standaard_km_tarief: 0.23,
    standaard_uurtarief: 45,
    standaard_materialen: ['Dibond', 'Acrylaat', 'Vinyl', 'LED modules', 'Aluminium profiel', 'RVS', 'Neon flex'],
    created_at: now(),
    updated_at: now(),
  }
}
