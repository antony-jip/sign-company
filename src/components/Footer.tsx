...
const footerNavigation = {
  ...
  locaties: [
    ...
    { name: 'Schagen', href: '/gevelreclame-schagen/' },
  ...
  legal: [
    ...
    { name: 'Cookie instellingen', href: '/cookies' },
  ],
};
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-sm">
              {companyInfo.slogan}. Sinds {companyInfo.foundedYear} uw partner voor
              hoogwaardige signing en reclame in Noord-Holland en Flevoland.
            </p>
          ...
          {/* Locaties */}
          <div>
            <h4 className="text-lg font-semibold mb-4">Locaties</h4>
            <ul className="space-y-2">
              {footerNavigation.locaties.map((item) => (
                <li key={item.name}>
                  <a
                    href={item.href}
                    className="text-gray-400 hover:text-white transition-colors"
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex space-x-6 mb-4 md:mb-0">
              <a
                href="https://facebook.com/signcompany"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="Facebook"
              >
              ...
              <a
                href="https://instagram.com/signcompany"
                className="text-gray-400 hover:text-white transition-colors"
              ...
              <a
                href="https://linkedin.com/company/signcompany"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="LinkedIn"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="text-center text-gray-500 text-sm mt-8">
            &copy; {currentYear} {companyInfo.name}. Alle rechten voorbehouden.
          </div>
        </div>
      </div>
    </footer>
