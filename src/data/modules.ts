...
export const modules: Module[] = [
  ...
  { label: 'Visualizer', sub: 'AI toont het eindresultaat', href: '/features/visualizer', color: '#9A5A48', icon: IconVisualizer, comingSoon: true, seoTitle: 'Sign-visualizer met AI | doen.', seoDescription: 'Laat AI het eindresultaat op de gevel tonen voordat je produceert. Binnenkort in doen.' },
