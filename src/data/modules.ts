...
export const modules: Module[] = [
  ...
  { label: 'Offertes', groep: 'Binnenhalen', sub: 'Professioneel in minuten', href: '/features/offertes', color: '#D24620', icon: IconOffertes, seoTitle: 'Offertesoftware voor signmakers | doen.', seoDescription: 'Calculeer en verstuur professionele offertes in minuten. Je klant keurt goed via het portaal, doen. volgt automatisch op.' },
  ...
  { label: 'Facturen', groep: 'Factureren', sub: 'Verkoop én inkoop, AI leest uit', href: '/features/facturen', color: '#2D6B48', icon: IconFacturen, seoTitle: 'Factuursoftware voor signbedrijven | doen.', seoDescription: 'Van offerte naar factuur in één klik, met Mollie-betaallink. De koppeling met Exact Online werkt heen en terug, dus je ziet in doen. wat betaald is. AI leest inkoopfacturen uit.' },
  ...
  { label: 'Taken', groep: 'Plannen', sub: 'Alles naast de montage', href: '/features/taken', color: '#D24620', icon: IconTaken, seoTitle: 'Takenbeheer voor signbedrijven | doen.', seoDescription: 'Alles naast de montage: taken per project en per collega, met deadlines. Niks valt tussen wal en schip.' },
