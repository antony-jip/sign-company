    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      ...
      <div className="rounded-xl border border-petrol/15 bg-petrol/[0.03] p-5">
        ...
        <p className="mt-2 text-xs text-muted-foreground bg-muted/50 p-3 rounded-lg italic leading-relaxed">
          ...
          type;bedrijfsnaam;naam;nummer;datum;bedrag;adres;postcode;plaats;telefoon;email;kvk_nummer;debiteurennummer;btw_nummer;verantwoordelijke.
          Type is: relatie, project, offerte, of factuur.
          Bij relatie: vul bedrijfsnaam + adres/postcode/plaats/telefoon/email/kvk_nummer/debiteurennummer/btw in.
