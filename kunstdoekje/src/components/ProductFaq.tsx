...
const VRAGEN = [
  ...
  },
  {
    ...
    a: 'Een aluminium wisselframe dat je één keer ophangt en jaren meegaat. Het doek heeft rondom een pees die je in de gleuf drukt · strak gespannen, zonder golvingen.',
  },
  {
